...
import com.apxium.myapp.service.DepartmentService;
...
public class DepartmentResourceIntTest {
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getManager()).isEqualTo(DEFAULT_MANAGER);
    }
    ...
    public void updateDepartment() throws Exception {
        ...
        assertThat(testDepartment.getManager()).isEqualTo(UPDATED_MANAGER);
    }
